...
def run():
    image = cv2.imread('png/b.png')  # a black objects on white image is better
    ...
    cv2.imwrite('c.png',draw_min_rect_circle(image, contours))
    cv2.imwrite('d.png',draw_approx_hull_polygon(image, contours))
#     for img in imgs:
